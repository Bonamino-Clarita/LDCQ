...
## Install git
1. Apri un terminale e lancia `git --version`. Se ti dice che `git` non esiste e ti consiglia di instalare <b>Command Line Developer Tools</b> isntallalo come ti dice. Se non dice altro oltre a `git command does not exist` vai al punto 2.
2. Sempre dal terminale lancia `xcode-select --install` .
